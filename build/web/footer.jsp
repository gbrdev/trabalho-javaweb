...
<!-- INICIO DO FOOTER -->
    ...
    <div class="w-12xl md-auto text-gray-800 flex flex-wrap justify-between">
      <div class="p-5 w-48 ">
        <div class="text-xs uppercase text-gray-500 font-medium">Empresa</div>
          <a class="my-3 block" href="/#">Serviços <span class="text-teal-600 text-xs p-1"></span></a>
          <a class="my-3 block" href="/#">Produtos <span class="text-teal-600 text-xs p-1"></span></a>
